        ...
        for (int i = 0; i < countOfVertices - 1; i++) {
            ...
            for (int vertex = 0; vertex < countOfVertices; vertex++)
                ...
                if (graphArray[edge][vertex] != 0 && setOfMST[vertex] == false && graphArray[edge][vertex] < keys[vertex]) {
                    mstArray[vertex] = edge;//parent array
